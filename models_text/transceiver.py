...
import math
from keras.layers import GlobalAveragePooling2D, Dense, Concatenate, Multiply
...
class ChannelDecoder(nn.Module):
    def __init__(self, in_features, size1, size2):  #tcn, d_model, 512
...
class DeepSC(nn.Module):                          ############
    def __init__(self, tcn, num_layers, src_vocab_size, trg_vocab_size, src_max_len,
        ...
        self.channel_encoder = nn.Sequential(nn.Linear(d_model, 256), 
                                             ...
                                             nn.Linear(256, tcn))           ####################tcn


        self.channel_decoder = ChannelDecoder(tcn, d_model, 512)            ####################tcn
